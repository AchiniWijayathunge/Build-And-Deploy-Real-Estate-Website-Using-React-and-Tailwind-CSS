...
const Footer = () => {
  return (
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
      <div className='container mx-auto flex flex-col md:flex-row justify-between items-start'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
          ...
          <p className='text-gray-400 mt-r'>
            ...
            life you desire in the luxury apartments for sale in Sri Lanka.
          </p>
        </div>
        <div className='w-full md:w-1/5 mb-8 md:mb-0'>
          <h3 className='text-white text-lg font-bold mb-4'> Company</h3>
          <ul className='flex flex-col gap-2 text-grey-400'>
      ...
      <div className='border-t border-gray-700 py-t mt-10 text-center text-grey-500'> Copyright 2024 Achini Wijayathunge All right received
      </div>
    </div>
